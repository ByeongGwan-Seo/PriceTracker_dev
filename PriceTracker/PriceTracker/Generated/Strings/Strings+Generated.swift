...
internal enum L10n {
  /// OK
  internal static let alertDismissOk = L10n.tr("Localizable", "alert_dismiss_ok", fallback: "OK")
  ...
  /// https://www.cheapshark.com/img/stores/logos/%@.png
  internal static func thumbnailImageUrl(_ p1: Any) -> String {
    return L10n.tr("Localizable", "thumbnail_image_url", String(describing: p1), fallback: "https://www.cheapshark.com/img/stores/logos/%@.png")
  }
}
